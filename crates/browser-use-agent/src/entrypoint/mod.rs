...
impl StoreTurnState {
    ...
    fn new(store: SharedStore, session_id: SessionId, recorded: RecordedBuffer) -> Self {
        Self {
            ...
            base_instructions: crate::prompts::system_prompt().to_string(),
            current_model: None,
...
fn base_instructions_for_config(config: &ProviderRunConfig) -> String {
    config
        ...
        .base_instructions
        .clone()
        .unwrap_or_else(|| crate::prompts::system_prompt().to_string())
}
...
async fn drive_run<Sd: SamplingDriver>(
    ...
    .with_compaction_instructions(
        base_instructions.unwrap_or_else(|| crate::prompts::system_prompt().to_string()),
